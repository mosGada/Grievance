'use strict';
app.controller('driverDetailController', ['$scope', 'companyService', 'authService', '$uibModalInstance', function ($scope, companyService, authService, $uibModalInstance) {
    $scope.userRole = authService.authentication.userRole;
  
    $scope.userRolecompany = [];
